export const en = {
  ...
  privacy: {
    ...
    s1NoAccountTitle: "No accounts: ",
    s1NoAccountBody:
      "The site has no sign-up or login and does not collect personal identity information such as name, phone, or address.",
    ...
    s3Body:
      "Core browsing does not rely on login-state cookies. If third-party analytics or ads are added later, they may use cookies or similar technologies, which you can clear or disable in your browser settings at any time.",
